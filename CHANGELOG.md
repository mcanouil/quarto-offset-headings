...
- docs: Add worked examples for the range limits, the end of a cascade, the document-level cascade defaults, the messages the filter reports, and Quarto's automatic heading shift. (#30)
